...
public class GmailAuthorize {
	/** Application name. */
	private static final String APPLICATION_NAME = "GmailApp";

	/** Directory to store user credentials for this application */
	private static final java.io.File DATA_STORE_DIR = new java.io.File(
		System.getProperty("user.home"), "credentials/gmail-app");
	...
	/** Global instance of the sopes required by this quickstart. */
	// Listing out all lables
	...
	*/
	public static Credential authorize() throws IOException {
		...
		System.out.println(
			"Credential saved to " + DATA_STORE_DIR.getAbsolutePath());
		return credential;
	}
